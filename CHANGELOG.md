...
### Updated
- Minor depdendency update release

## [0.2.3] - 2026-07-18

### Changed
- Redefined distinct user count for "connected_clients" and added "connected_sockets" for a more accurate count of connected users and sockets. (by @HB9HIL)

## [0.2.2] - 2026-07-13

### Changed
- Updated workflow actions. (by @HB9HIL)
- Improved performance for status endpoints (by @HB9HIL)
